...
export default function TiaCard() {
    ...
    return (
        <ReactCardFlip
            ...
            <Card onClick={() => setSelected(true)} className="mack-card shadow-2xl bg-[#A03034] w-[40rem] h-[25rem] flex flex-col justify-center items-center text-center">
            ...
            <Card onClick={() => setSelected(false)} className="mack-card shadow-2xl bg-[#A03034] w-[40rem] h-[25rem] flex flex-col justify-center items-center text-center">
            </Card>
        </ReactCardFlip>
    );
}
